...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    // Task 1b.1: Remove the "FIXME" label. It is nice but not very practical.
    ...
    G4Material* bc400 = new G4Material("BC400",1.032 * g/cm3, 2);    // To be defined
    ...
    G4VSolid* scintillatorBox = new G4Box("Scintillator", thickness, width, height);
    ...
    G4LogicalVolume* scintillatorLog = new G4LogicalVolume(scintillatorBox, bc400, "scintillator"); 
    ...
    absorberLog -> SetVisAttributes(green);
    ...
    {
        absorberPositions.push_back({minX + i*2 * 2*thickness, 0, 0});
        scintillatorPositions.push_back({minX + (i * 2 + 1) * 2*thickness, 0, 0});
    }
    ...
    G4cout <<  absorberPositions[i]<< G4endl;
    G4cout <<"absorber "<< G4endl;
    ...
    G4cout <<scintillatorPositions[i] << G4endl;
